...
namespace csharp
{
    class Program
    {
        ...
        public static void ValidateValidChecksum()
        {
        ...
        public static void ValidAddress()
        {
        ...
        private static byte[] Scriptpubkey(byte witver, byte[] witprog)
        {
            ...
            return (new[] { (byte)v, (byte)witprog.Length }).Concat(witprog).ToArray();
        }
    }
}
